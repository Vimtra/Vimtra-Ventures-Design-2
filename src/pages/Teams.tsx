  ...
  return (
    <>
      ...
      <div className="team-carousel-section">
        ...
        <div className="active-member-header text-center reveal reveal-in" style={{ minHeight: "120px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", marginBottom: "-95px", marginTop: "30px", position: "relative", zIndex: 10 }}>
        ...
        {/* Wrapper for Viewport & Overlay to allow bubble content popouts without clipping */}
        <div className="carousel-wrapper" style={{ position: "relative", width: "100%", maxWidth: "1000px", margin: "20px auto" }}>

          {/* 100% Horizontal Gradient Blur Overlay on the sides */}
          <div className="carousel-side-blur-overlay" />

          {/* Carousel Viewport (Masked horizontally) */}
          <div className="carousel-viewport" style={{
            WebkitMaskImage: "linear-gradient(to right, transparent 0%, black 15%, black 85%, transparent 100%)",
            maskImage: "linear-gradient(to right, transparent 0%, black 15%, black 85%, transparent 100%)",
            margin: 0
          }}>
            <div className="carousel-container" style={{ transform: `rotateY(${-activeIndex * 30}deg) translateZ(60px)` }}>
              {DUPLICATED_MEMBERS.map((member, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      transform: `rotateY(${theta}deg) translateZ(-480px)`,
                    }}
                  >
            ...
            {/* 2D hover/click proxy — sits in the 2D layer over the center card position
                since the 3D cards at translateZ are unreachable by hit-testing */}
            <div
          ...
          {/* 2D Overlay for Bubbles — Sits outside the masked viewport to avoid vertical clipping */}
          <div className="bubbles-container" style={{ position: "absolute", left: "50%", top: "50%", width: "240px", height: "320px", transform: "translate(-50%, -50%)", zIndex: 100, pointerEvents: "none" }}>
            {activeMember.sections && activeMember.sections.map((s, idx) => (
              <div key={idx} className={`bubble-floating-wrapper bubble-floating-wrapper-${idx}`}>
                <div
        ...
        <div className="carousel-active-info">
          <div className="wrap">
            <div className="team-profile-bio text-center" style={{ maxWidth: "900px", margin: "0 auto" }}>
              {typeof activeMember.bio === "string" ? <p style={{ fontSize: "16px", lineHeight: 1.5, color: "var(--text-dim)", margin: 0 }}>{activeMember.bio}</p> : activeMember.bio}
            </div>
          </div>
        </div>
      </div>
